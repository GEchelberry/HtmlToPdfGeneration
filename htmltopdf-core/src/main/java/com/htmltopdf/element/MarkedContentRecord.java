...
/**
 * Class to hold the marked content data
 */
public class MarkedContentRecord implements Element {
    private int objectId;
    private Page page;
    private int mcid;

    /**
     * Constructor - Sets the page of the marked content
     * @param page Page object
     */
    public MarkedContentRecord(Page page) {
        this.page = page;
    }

    /**
     * Sets the mcid for the marked content
